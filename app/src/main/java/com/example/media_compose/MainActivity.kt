package com.example.media_compose
...
import com.example.media_compose.ui.theme.Media_ComposeTheme
...
fun Greeting(name: String) {
    ...
    Row{
        ...
        Button(onClick = {
            mper.reset()
            context.startActivity(Intent(context, ViedoActivity::class.java))},
            Modifier
                .fillMaxWidth ()
                .fillMaxHeight(0.7f),
